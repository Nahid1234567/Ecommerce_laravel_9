			        ...
			        <div class="row">
			            <div class="col">
			                <div class="brands_slider_container">  
			                    ...
			                    <div class="brands_nav brands_prev"><i class="far fa-chevron-left"></i></div>
			                    <div class="brands_nav brands_next"><i class="far fa-chevron-right"></i></div>
			                </div>
			            </div>
			        </div>
			    </div>
					...
					<div class="shop_content">
						<div class="shop_bar clearfix">
							...
							<div class="shop_sorting">
								...
								<ul>
									<li>
										<span class="sorting_text">highest rated<i class="far fa-chevron-down"></i></span>
										<ul>
							...
							@foreach($products as $row)
								<div class="product_item is_new col-lg-2">
									...
									<ul class="product_marks">
										<li class="product_mark product_new quick_view" id="{{ $row->id }}" data-toggle="modal" data-target="#exampleModalCenter"><i class="far fa-eye"></i></li>
									</ul>
								</div>
							@endforeach
						</div>
                ...
                <div class="col">
                    <div class="viewed_title_container">
                        ...
                        <div class="viewed_nav_container">
                            <div class="viewed_nav viewed_prev"><i class="far fa-chevron-left"></i></div>
                            <div class="viewed_nav viewed_next"><i class="far fa-chevron-right"></i></div>
                        </div>
                    </div>
