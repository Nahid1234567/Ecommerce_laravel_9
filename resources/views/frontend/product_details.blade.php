			...
			<div class="row">
				...
				<div class="col-lg-4 order-lg-2 order-1" >
					...
					@isset($images)	
						...
						<l1 data-image="{{asset('files/product/'.$image)}}">
						<img src="{{asset('files/product/'.$image)}} " alt="" height=200px; width=100px; >
                        </li>
						@endforeach
					@endisset
					</ul>
				...
				<!-- Selected Image -->
				<div class="col-lg-4 order-lg-2 order-1">
					<div class="image_selected"><img src="{{asset('files/product/'.$product->thumbnail)}}" height=100px; width=100px; alt=""></div>
				</div>
				...
				<div class="col-lg-6 order-3">
					<div class="product_description">
						<div class="product_category">{{$category->category_name}}>
						{{$subcategory->subcategory_name}}
						</div>
						<div class="product_name" style="font-size: 20px;">{{$product->name}}</div>
						<div class="product_name"><b> brand: {{$product->brand->brand_name}}</b></div>
						<div class="product_name"><b> Stock: {{$product->stock_quantity}}</b></div>
						<div class="product_name"><b> Unit: {{$product->unit}}</b></div>
						@if($sum_rating !=NULL)	
						...
						<div class="rating_r rating_r_4 product_rating"><i></i><i></i><i></i><i></i><i></i></div>
						    @if($product->discount_price == NULL)
							 ...
							 <div class="product_price">
								<del class="text-danger">{{$setting->currency}} {{$product->selling_price}}</del>
